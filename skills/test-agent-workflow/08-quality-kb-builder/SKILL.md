---
name: quality-kb-builder
description: Use when the project testing knowledge, business chains, test assets, skill coverage, risk tags, or AI testing memories need to be built, refreshed, reviewed, or turned into a reusable knowledge base before planning, review, benchmark, or onboarding.
---
...
3. Check graph reviewer output:
   ...
   - each skill path in `skill-index.yml` exists
