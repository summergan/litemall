---
name: contract-test
description: Implement or run a project contract-test execution item after Test Strategy selects the contract layer. Use for route, method, schema, serialization, event, XML, or consumer-provider compatibility evidence.
---
