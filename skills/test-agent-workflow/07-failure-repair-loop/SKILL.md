---
name: failure-repair-loop
description: Classify failed test execution as product, design, strategy, test, fixture, runner, or environment defects; make only authorized minimal repairs, rerun targeted evidence, and preserve an auditable report.
---
